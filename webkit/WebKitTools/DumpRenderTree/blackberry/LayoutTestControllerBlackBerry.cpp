...
{
    Olympia::WebKit::WebSettings::pageGroupSettings(Olympia::WebKit::DumpRenderTree::currentInstance()->pageGroupName())->setXSSAuditorEnabled(flag);
}
...
void LayoutTestController::setMockSpeechInputResult(const JSStringRef result)
{
    notImplemented();
}
