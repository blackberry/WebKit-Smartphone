...
namespace Olympia {
    namespace WebKit {
        ...
        public:
            ...
            void renderDirectToCanvas(const WebCore::IntRect& rect, bool renderContentOnly);
            ...
            void blitScaledArbitraryRectFromBackingStoreToScreen(const WebCore::IntRect& srcRect, WebCore::IntRect dstRect, Olympia::Platform::Graphics::Buffer* tempBuffer);
