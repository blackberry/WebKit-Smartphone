...
namespace Olympia {
    namespace WebKit {
        ...
        public:
            ...
            static PassOwnPtr<BackingStoreTile> createCheckered(const WebCore::IntSize& size)
            {
                return new BackingStoreTile(size, true /*checkered*/);
            }
