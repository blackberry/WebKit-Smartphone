...
public:
    ...
    void setLineSpacingOverride(double ascent, double descent);
    void unsetLineSpacingOverride();
    bool hasLineSpacingOverride() const;
    double ascentOverride() const { return m_ascentOverride; }
    double descentOverride() const { return m_descentOverride; }
    double lineSpacingOverride() const { return m_ascentOverride + m_descentOverride; }
...
private:
    ...
    double m_ascentOverride;
    double m_descentOverride;
};
