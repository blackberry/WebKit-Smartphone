...
class TiledImageOpenVG : public SharedResourceOpenVG, public RefCounted<TiledImageOpenVG> {
public:
    ...
    /**
     * Replace the existing image tile with a new one. If this tile has already
     * been set to a valid VGImage, that VGImage is destroyed.
     */
