...
{
    return new TextCodecBlackBerry(reinterpret_cast<unsigned>(additionalData));
}
...
TextCodecBlackBerry::TextCodecBlackBerry(unsigned encodingID)
    : m_encodingID(encodingID)
{
}

TextCodecBlackBerry::~TextCodecBlackBerry()
{
}

void TextCodecBlackBerry::registerBaseEncodingNames(EncodingNameRegistrar registrar)
{
...
void TextCodecBlackBerry::registerBaseCodecs(TextCodecRegistrar registrar)
{
    getSupportedEncodings();
    for (unsigned i = 0; i < gSupportedEncodings.size(); ++i)
...
void TextCodecBlackBerry::registerExtendedEncodingNames(EncodingNameRegistrar registrar)
{
}

void TextCodecBlackBerry::registerExtendedCodecs(TextCodecRegistrar registrar)
{
}
...
String TextCodecBlackBerry::decode(const char* bytes, size_t length, bool flush, bool stopOnError, bool& sawError)
{
...
CString TextCodecBlackBerry::encode(const UChar* characters, size_t length, UnencodableHandling errorHandling)
{
