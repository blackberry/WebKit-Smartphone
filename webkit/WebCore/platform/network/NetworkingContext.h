...
#if PLATFORM(OLYMPIA)
    // FIXME: the whole point of NetworkingContext is not to pass Frame
    // directly.  Need to rework NetworkManager to take a NetworkingContext
    // instead.  (RIM Bug #1515)
    virtual Frame* wrappedFrame() const = 0;
#endif
