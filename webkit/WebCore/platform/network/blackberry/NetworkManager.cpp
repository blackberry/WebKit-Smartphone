...
public:
    ...
    bool initialize(int playerId, const WTF::String& pageGroupName, const KURL& url, const Platform::NetworkRequest& request, PassRefPtr<ResourceHandle> handle, Platform::NetworkStreamFactory* streamFactory, int deferLoadingCount, int redirectCount)
    {
        m_playerId = playerId;
...
private:
    ...
    void sendResponseIfNeeded()
    {
        ...
        WTF::String mimeType = m_response.httpHeaderField("x-rim-sniffed-mime-type");
        if (mimeType.isNull())
...
bool NetworkManager::startJob(int playerId, const WTF::String& pageGroupName, PassRefPtr<ResourceHandle> job, const ResourceRequest& request, Platform::NetworkStreamFactory* streamFactory, int deferLoadingCount, int redirectCount)
{
