...
namespace Olympia {
    ...
    namespace WebKit {
        ...
        private:
            ...
            bool startJob(int playerId, const WTF::String& pageGroupName, WTF::PassRefPtr<WebCore::ResourceHandle> job, const WebCore::ResourceRequest& request, Platform::NetworkStreamFactory* streamFactory, int deferLoadingCount = 0, int redirectCount = 0);
