...
public:
    ...
    IntSize contentsSizeFromHistory() const { return m_contentsSizeFromHistory; }
    void setContentsSizeFromHistory(const IntSize&);
...
#if PLATFORM(OLYMPIA)
    double m_firstLayoutScheduleStartTime;
#endif
};
