...
a[i++] = new TestObject(
  "dt.setInteger(new Boolean(true))",
  "dt.PUB_INT",
  "dt.getInteger()",
...
a[i++] = new TestObject(
  "dt.setInteger(new Boolean(false))",
  "dt.PUB_INT",
  "dt.getInteger()",
  "typeof dt.getInteger()",
  '0',
...
a[i++] = new TestObject(
  "dt.setInteger(new String('2147483647'))",
  "dt.PUB_INT",
  "dt.getInteger()",
  "typeof dt.getInteger()",
  '2147483647',
...
a[i++] = new TestObject(
  "dt.setInteger(new String('-2147483648'))",
  "dt.PUB_INT",
  "dt.getInteger()",
  "typeof dt.getInteger()",
  '-2147483648',
...
a[i++] = new TestObject(
  "dt.setInteger(new MyObject('5.5'))",
  "dt.PUB_INT",
  "dt.getInteger()",
  "typeof dt.getInteger()",
  '5',
...
a[i++] = new TestObject(
  "dt.setInteger(new MyOtherObject('-107.5'))",
  "dt.PUB_INT",
  "dt.getInteger()",
  "typeof dt.getInteger()",
  '-107',
...
a[i++] = new TestObject(
  "dt.setInteger(new AnotherObject('6666'))",
  "dt.PUB_INT",
  "dt.getInteger()",
  "typeof dt.getInteger()",
  '6666',
