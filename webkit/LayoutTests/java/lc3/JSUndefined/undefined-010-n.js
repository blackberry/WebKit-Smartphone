...
// passing undefined to a java method that expects a boolean be an error

DESCRIPTION = "dt.setBoolean( undefined )";
EXPECTED = "error";

a[i++] = new TestObject(
  "dt.setBoolean( undefined )",
  "dt.PUB_BOOLEAN",
  "dt.getBoolean()",
