...
{
return ['XPathResult_stringValue'];
}
...
*/
function XPathResult_stringValue() {
   var success;
    if(checkInitialization(builder, "XPathResult_stringValue") != null) return;
    var ANY_TYPE = 0;
      var NUMBER_TYPE = 1;
      var STRING_TYPE = 2;
      var BOOLEAN_TYPE = 3;
      ...
      var expression = "/staff/employee/salary[text()='56,000']";
...
outresult = evaluator.evaluate(expression,contextNode,resolver,xpathType,inresult);
      ...
      assertEquals("same","56,000",stringValue);
