...
{
return ['XPathNSResolver_lookupNamespaceURI_prefix'];
}
...
*/
function XPathNSResolver_lookupNamespaceURI_prefix() {
   var success;
    if(checkInitialization(builder, "XPathNSResolver_lookupNamespaceURI_prefix") != null) return;
    var doc;
      var resolver;
      var evaluator;
      var element;
