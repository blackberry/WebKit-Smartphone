...
{
return ['XPathResult_singleNodeValue_FIRST_ORDERED_NODE_TYPE'];
}
...
*/
function XPathResult_singleNodeValue_FIRST_ORDERED_NODE_TYPE() {
   var success;
    if(checkInitialization(builder, "XPathResult_singleNodeValue_FIRST_ORDERED_NODE_TYPE") != null) return;
    var ANY_TYPE = 0;
      var NUMBER_TYPE = 1;
      var STRING_TYPE = 2;
      var BOOLEAN_TYPE = 3;
...
outresult = evaluator.evaluate(expression,contextNode,resolver,xpathType,inresult);
      ...
      assertEquals("equals","EMP0001",data);
