...
{
return ['XPathResult_snapshotLength_UNORDERED_NODE_SNAPSHOT_TYPE'];
}
...
*/
function XPathResult_snapshotLength_UNORDERED_NODE_SNAPSHOT_TYPE() {
   var success;
    if(checkInitialization(builder, "XPathResult_snapshotLength_UNORDERED_NODE_SNAPSHOT_TYPE") != null) return;
    var ANY_TYPE = 0;
      var NUMBER_TYPE = 1;
      var STRING_TYPE = 2;
      var BOOLEAN_TYPE = 3;
...
outresult = evaluator.evaluate(expression,contextNode,resolver,xpathType,inresult);
      ...
      assertEquals("same",5,snapshotLength);
