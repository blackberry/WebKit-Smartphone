...
{
return ['XPathResult_invalidIteratorState_ANY_UNORDERED_NODE_TYPE'];
}
...
*/
function XPathResult_invalidIteratorState_ANY_UNORDERED_NODE_TYPE() {
   var success;
    if(checkInitialization(builder, "XPathResult_invalidIteratorState_ANY_UNORDERED_NODE_TYPE") != null) return;
    var ANY_TYPE = 0;
      var NUMBER_TYPE = 1;
      var STRING_TYPE = 2;
      var BOOLEAN_TYPE = 3;
