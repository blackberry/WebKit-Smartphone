...
{
return ['XPathResult_booleanValue_false'];
}
...
*/
function XPathResult_booleanValue_false() {
   var success;
    if(checkInitialization(builder, "XPathResult_booleanValue_false") != null) return;
    var ANY_TYPE = 0;
      var NUMBER_TYPE = 1;
      var STRING_TYPE = 2;
      var BOOLEAN_TYPE = 3;
      ...
      var expression = "/staff/workerbee";
