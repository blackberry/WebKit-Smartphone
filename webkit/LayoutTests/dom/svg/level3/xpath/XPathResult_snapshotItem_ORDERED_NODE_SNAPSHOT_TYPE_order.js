...
{
return ['XPathResult_snapshotItem_ORDERED_NODE_SNAPSHOT_TYPE_order'];
}
...
*/
function XPathResult_snapshotItem_ORDERED_NODE_SNAPSHOT_TYPE_order() {
   var success;
    if(checkInitialization(builder, "XPathResult_snapshotItem_ORDERED_NODE_SNAPSHOT_TYPE_order") != null) return;
    var ANY_TYPE = 0;
      var NUMBER_TYPE = 1;
      var STRING_TYPE = 2;
      var BOOLEAN_TYPE = 3;
