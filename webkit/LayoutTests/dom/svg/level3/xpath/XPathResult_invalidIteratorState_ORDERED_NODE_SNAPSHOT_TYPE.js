...
{
return ['XPathResult_invalidIteratorState_ORDERED_NODE_SNAPSHOT_TYPE'];
}
...
*/
function XPathResult_invalidIteratorState_ORDERED_NODE_SNAPSHOT_TYPE() {
   var success;
    if(checkInitialization(builder, "XPathResult_invalidIteratorState_ORDERED_NODE_SNAPSHOT_TYPE") != null) return;
    var ANY_TYPE = 0;
      var NUMBER_TYPE = 1;
      var STRING_TYPE = 2;
      var BOOLEAN_TYPE = 3;
