...
shouldBeEqualToString("radialGradientElement.getAttribute('fy')", "0%");

function executeTest() {
    radialGradientElement.setAttribute("fy", "50%");
    shouldBeEqualToString("radialGradientElement.getAttribute('fy')", "50%");
