...
win32-*|olympia-* {
    INCLUDEPATH += $$(BBNSLINSTALLPREFIX)/include/jpeg
    INCLUDEPATH += $$(BBNSLINSTALLPREFIX)/include/libpng
    INCLUDEPATH += $$(BBNSLINSTALLPREFIX)/include/libxml2
    INCLUDEPATH += $$(BBNSLINSTALLPREFIX)/include/libxslt
    INCLUDEPATH += $$(BBNSLINSTALLPREFIX)/include/tid
    INCLUDEPATH += $$(BBNSLINSTALLPREFIX)/include/zlib
...
!CONFIG(QTDIR_build) {
    ...
    win32-msvc-fledge|olympia-armcc-* {
        VERSION=
    }
