...
public:
    ...
    IntRect absoluteLayoutOverflowRect() const { return m_absoluteOverflow ? m_absoluteOverflow->layoutOverflowRect() : layoutOverflowRect(); }
    IntRect absoluteVisualOverflowRect() const { return m_absoluteOverflow ? m_absoluteOverflow->visualOverflowRect() : visualOverflowRect(); }
    int rightAbsoluteLayoutOverflow() const { return m_absoluteOverflow ? m_absoluteOverflow->rightLayoutOverflow() : rightVisualOverflow(); }
    int bottomAbsoluteLayoutOverflow() const { return m_absoluteOverflow ? m_absoluteOverflow->bottomLayoutOverflow() : bottomVisualOverflow(); }
    int rightAbsoluteVisibleOverflow() const { return m_absoluteOverflow ? m_absoluteOverflow->visibleOverflowRect().right() : rightVisualOverflow(); }
    int bottomAbsoluteVisibleOverflow() const { return m_absoluteOverflow ? m_absoluteOverflow->visibleOverflowRect().bottom() : bottomVisualOverflow(); }

    void addAbsoluteLayoutOverflow(const IntRect&);
    void addAbsoluteVisualOverflow(const IntRect&);
...
protected:
    ...
    // Our propogated overflow information which includes information from children regardless of overflow clip.
    OwnPtr<RenderOverflow> m_absoluteOverflow;
