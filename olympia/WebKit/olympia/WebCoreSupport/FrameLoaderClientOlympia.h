...
class FrameLoaderClientOlympia : public FrameLoaderClient {
public:
    FrameLoaderClientOlympia();
    ~FrameLoaderClientOlympia();
    ...
    virtual void dispatchWillSendRequest(DocumentLoader*, long unsigned int, ResourceRequest&, const ResourceResponse&) { notImplemented(); }
    ...
    virtual void dispatchDidCancelClientRedirect() { notImplemented(); }
...
private:
    ...
    void invalidateBackForwardTimerFired(Timer<FrameLoaderClientOlympia>*);

    PassRefPtr<Widget> createPluginHolder(const IntSize& pluginSize,
    ...
    mutable Timer<FrameLoaderClientOlympia>* m_invalidateBackForwardTimer;
